...
public class OrdrePodiatresTest {
    ...
    public void  before() throws Exception {
        ...
        declarationValide.put("ordre", "podiatres");
        declarationValide.put("numero_de_permis", "00000");
    ...
    public void testCreerCycleValide() throws Exception {
        ...
        Cycle cycleAttendu = new Cycle("2013-06-01", "2016-06-01", 60.0);
